...
  // Added a separate logout item object for the sidebar
  const logoutItem = { path: "#", name: "Logout", icon: LogOut, action: true }; 
...
            {/* Logout Item for Mobile/Sidebar - HIDDEN on LG (Desktop) and up */}
            <button
              onClick={logout}
              className={`
                flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 w-full text-left
                text-red-600 bg-red-50 hover:bg-red-100 hover:text-red-800 border border-red-200
                lg:hidden 
              `}
            >
...
            </h2>
            
            {/* Desktop Logout Button (Visible only on MD and up) */}
            <div className="hidden md:flex items-center spaxe-x-4">
              <div className="text-sm text-gray-500">
                <p
                  onClick={logout}
